  ...
  return (
    <div className="subportal-auth-wrap portal-textured">
      <div className="subportal-auth-brand">
        <img src={logoUrl} alt="McLoud Construction" className="subportal-auth-logo" style={{ height: 100, width: 'auto' }} />
        <div>
      ...
      <div className="subportal-auth-content">
        <img src={logoUrl} alt="McLoud Construction" className="subportal-auth-logo-mobile" style={{ height: 100, width: 'auto' }} />
        {children}
      </div>
    </div>
  );
