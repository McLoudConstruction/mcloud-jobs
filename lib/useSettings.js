...
function applyTheme(settings) {
  ...
  root.style.setProperty('--gold', settings.color_section_heading);
  ...
  root.style.setProperty('--sidebar-inactive-text', settings.sidebar_inactive_text);
  root.style.setProperty('--sidebar-active-bg', settings.sidebar_active_bg);
  root.style.setProperty('--sidebar-active-text', settings.sidebar_active_text);
