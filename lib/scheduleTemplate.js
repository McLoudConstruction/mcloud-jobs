...
//                 stage. Two stages can share a trade (electrical shows up
//                 at both rough_in and finish_trades) — the AI disambiguates
//                 using the action's description, not just its trade tag.
...
export const PHASE_STAGES = [
  ...
  { key: 'finish_trades', label: 'Finish electrical & plumbing', trades: ['Electrical', 'Plumbing'], dependsOn: ['countertops'] },
  { key: 'landscaping', label: 'Landscaping', trades: ['Landscaping'], dependsOn: ['exterior'] },
  { key: 'punch_list', label: 'Punch list & walkthrough', trades: ['General Labor', 'Other'], dependsOn: ['finish_trades', 'painting'], synthetic: true },
];
