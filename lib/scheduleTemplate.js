...
export const PHASE_STAGES = [
  ...
  { key: 'punch_list', label: 'Punch list & walkthrough', trades: ['General Labor', 'Other'], dependsOn: ['electrical_finish', 'plumbing_finish', 'tile_finish', 'painting'], synthetic: true, preferredStartDay: 'monday' },
];
